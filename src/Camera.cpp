...
Camera::Camera(float viewWidth, float viewHeight): _pos(0.0, 0.0, 0.0), _pos_view(0.0, 0.0, 1.0), _dir(0.0, 1.0, 0.0)
{
    _projection = glm::perspective(45.0f, viewWidth / viewHeight, 0.1f, 100.0f);
}
