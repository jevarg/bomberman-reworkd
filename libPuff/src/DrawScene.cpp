...
void DrawMesh(FbxNode* pNode, FbxTime& pTime, FbxAnimLayer* pAnimLayer,
              FbxAMatrix& pGlobalPosition, FbxPose* pPose, puff::AShader *shader, const glm::mat4 &transform);
...
void FbxMatrixToGlm(const FbxAMatrix& mat4, glm::mat4& glmMat);
                       ...
                       puff::AShader *shader, const glm::mat4 &transform)
{
    ...
    if (pNode->GetNodeAttribute())
    {
        ...
        DrawNode(pNode, pTime, pAnimLayer, pParentGlobalPosition, lGlobalOffPosition, pPose, shader, transform);
    }
    
    const int lChildCount = pNode->GetChildCount();
    for (int lChildIndex = 0; lChildIndex < lChildCount; ++lChildIndex)
    {
        DrawNodeRecursive(pNode->GetChild(lChildIndex), pTime, pAnimLayer, lGlobalPosition, pPose, shader, transform);
    }
}
...
//        {
//            DrawMesh(pNode, pTime, pAnimLayer, pGlobalPosition, pPose, pShadingMode, shader, transform);
//        }
...
//        }
        ...
        {
            DrawMesh(pNode, pTime, pAnimLayer, pGlobalPosition, pPose, shader, transform);
        }
    }
//    else
//    {
...
//            }
            ...
            glm::mat4 fbxMatrix;
            FbxMatrixToGlm(pGlobalPosition, fbxMatrix);

            shader->setUniform("model", transform * fbxMatrix);
