    ...
    mSupportVBO(pSupportVBO)
    {
        ...
        if (mSdkManager)
        {
            ...
            else
            {
                ...
                std::cerr << "Error: " << mImporter->GetStatus().GetErrorString() << std::endl;
            }
        }
        else
        {
...
//                FillCameraArray(mScene, mCameraArray);
            ...
            else
            {
                ...
                std::cerr << "Error reported: " << mImporter->GetStatus().GetErrorString() << std::endl;
            }
    ...
    bool FbxModel::SetCurrentAnimStack(int pIndex)
    {
...
//    bool FbxModel::SetCurrentCamera(const char * pCameraName)
//    {
//        if (!pCameraName)
//        {
//            return false;
...
//    }
    ...
    bool FbxModel::SetCurrentPoseIndex(int pPoseIndex)
    {
...
//                InitializeLights(mScene, mCurrentTime, lPose);
                DrawNodeRecursive(mSelectedNode, mCurrentTime, mCurrentAnimLayer, lDummyGlobalPosition, lPose, shader, transform);
//                DisplayGrid(lDummyGlobalPosition);
            ...
            {
//                InitializeLights(mScene, mCurrentTime, lPose);
                DrawNodeRecursive(mScene->GetRootNode(), mCurrentTime, mCurrentAnimLayer, lDummyGlobalPosition, lPose, shader, transform);
//                DisplayGrid(lDummyGlobalPosition);
            }
...
//    void FbxModel::OnKeyboard(unsigned char pKey)
//    {
...
//    }
//
//    void FbxModel::OnMouse(int pButton, int pState, int pX, int pY)
//    {
...
//    void FbxModel::OnMouseMotion(int pX, int pY)
//    {
//        int motion;
//
...
//    }
//
//    void FbxModel::DisplayGrid(const FbxAMatrix & pTransform)
//    {
//        glPushMatrix();
...
//    void FbxModel::SetZoomMode( CameraZoomMode pZoomMode)
//    {
